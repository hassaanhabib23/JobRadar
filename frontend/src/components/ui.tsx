...
// Every variant keys off the light/dark toggle (--fg-muted, --grad-accent,
// etc.) — nothing here is a fixed colour, so every button matches whichever
// theme the reader has chosen, everywhere it appears.
